        ...
        return (
            ...
            <div className="row reporthead" >
                <div className="col-12 col-md-8">
                    <div className="headtitle">Driver Log</div>
                </div>
            ...
            <div className="col-md-7 ">
                <div className="card">
                    <div className="card-header reviewhead3">
                        <div className="row">
                            <div className="col-md-8"><div className="reportheader">
                            <div className="ch">Report      </div> 
